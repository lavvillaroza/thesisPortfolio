                ...
                <div className="flex flex-col md:flex-col bg-background text-foreground mx-auto w-full h-full md:h-[750px]">
                    <main className="flex-1 w-full md:w-[1100px] md:h-full mx-auto h-full bg-emerald-600 bg-opacity-50 bg-gradient-to-br from-emerald-600 rounded">
                        <div className="flex flex-col-reverse md:flex-row gap-4 min-h-[700px] px-6 pt-5">
                            <div className="flex-auto w-full md:w-72 bg-gray-100 overflow-y-auto scrollbar scrollbar-thumb-green-700 scrollbar-track-gray-100 rounded p-5 mt-5">
                                {loading ? (
                                    ...
                                    <>
                                      <div className="mb-2"> 
                                          <div className="grid grid-cols-2 gap-4">                                              
                                            <div>
                                                <div className="mb-2">
                                                  <p className="text-gray-900 text-3xl">{studentDetail.studentName || 'N/A'}</p>                                      
                                                  <p className="text-gray-900 text-xl">{studentDetail.courseName || 'N/A'}</p>
                                                  <p className="text-gray-900 text-xl">{(studentDetail.studentId + ' - ' + getYearString(studentDetail.yearLevel)) || 'N/A'}</p>                                                  
                                                </div>                                                                                                 
                                            </div>
                                            <div className=""> 
                                                <div className="mb-2">
                                      ...
                                      <div className="grid grid-cols-2 gap-4">
                                        ...
                                        <div>                                      
                                          <blockquote className="text-lg italic font-semibold text-justify text-gray-600">

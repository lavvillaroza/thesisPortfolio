...
import { addStudentSeminar } from '../../../api/studentApi';
import { FaUserFriends } from 'react-icons/fa';
import { StudentSeminarModel } from '../../../models/StudentSeminarModel';
import { Datepicker } from 'flowbite';

interface SeminarOthersModalProps {
  userId: number;
  isOpen: boolean;
  onClose: () => void;
  onSeminarAdd: () => void;
...
const SeminarOthersModal: React.FC<SeminarOthersModalProps> = ({ userId, isOpen, onClose, onSeminarAdd }) => {
...
export default SeminarOthersModal;

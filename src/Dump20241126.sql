...
INSERT INTO `__efmigrationshistory` VALUES ('20241031145958_InitialMigrations','8.0.8'),('20241031150119_AddSubjectDetail','8.0.8'),('20241031185341_UpdatedTableSubjectAndOthers','8.0.8'),('20241112061555_UpdateStudentDetailTableInDB20241112','8.0.10'),('20241113125952_UpdateTableForStudentInformation','8.0.10'),('20241114132727_UpdateTableStudentSkill','8.0.10'),('20241117031056_UpdateStudentCertifAndRecogTable','8.0.10'),('20241117113410_UpdateStudentSeminarsTable','8.0.10'),('20241118131156_UpdateStudentSeminarTable','8.0.10'),('20241124060253_UpdateSubjectTakenColumnSubjectStatus','8.0.10');
...
CREATE TABLE `studentcertifsandrecogs` (
  `Id` int NOT NULL AUTO_INCREMENT,
  `Name` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `Attachment` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
INSERT INTO `studentcertifsandrecogs` VALUES (3,'Certificate Test One','Uploads\\StudentFiles\\cover1_9fbfd393-90f8-446f-9195-107e7bcc1ea6.jpg',1,'2024-11-17 14:43:03.968896',2,'2024-11-17 14:43:03.968763'),(5,'Recognition Test One','Uploads\\StudentFiles\\cover1_c6a6f7fc-9592-4af7-9e90-30879eefe9bf.jpg',2,'2024-11-17 15:03:08.564016',2,'2024-11-17 15:03:08.563697'),(6,'TEST','Uploads\\StudentFiles\\cover1_3ebb3b00-1f9e-415b-990a-6393415be58e.jpg',1,'2024-11-23 23:23:00.188791',2,'2024-11-23 23:23:00.188607'),(7,'TEST22','Uploads\\StudentFiles\\cover3_6f05e4d0-bbd0-462b-9bdb-638a25ad02db.jpg',2,'2024-11-23 23:23:25.103311',2,'2024-11-23 23:23:25.103232');
...
INSERT INTO `studentdetails` VALUES (1,'21-00904','Hurry John L. Salamanca',4,'A-1',2001,NULL,'hjsalamanca@gmail.com','hjsalamanca@gmail.com','','admin1','2024-11-12 16:56:14.071074',2,3,'Uploads\\StudentFiles\\A5_adf340ef-442a-49c3-810b-49bfd6daf55c.jpg','admin1','0001-01-01 00:00:00.000000'),(2,'21-00905','Lance Arjay Villaroza',4,'A-1',2020,NULL,'lance.villaroza@yahoo.com','','','admin1','2024-11-15 09:47:34.710917',3,1,'','','2024-11-15 09:47:34.710916');
...
CREATE TABLE `studentseminars` (
  ...
  `SeminarType` int NOT NULL,
  `CreatedDate` datetime(6) NOT NULL,
  `LastModifiedDate` datetime(6) NOT NULL,
  `UserId` int NOT NULL,
  `SeminarId` int NOT NULL DEFAULT '0',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `studentseminars` VALUES (1,'Announcement 1','School','2024-11-23 00:00:00.000000','Lorem ipsum dolor sit amet. Non totam internos aut aliquam expedita et incidunt officia ut repudiandae eveniet. A cumque repudiandae eum asperiores voluptas aut illo blanditiis ab inventore inventore qui internos voluptatem. Ut tempora facilis vel dolores veniam ea voluptas voluptates ut rerum autem hic nostrum rerum. Rem minus dolorum id modi error ut blanditiis delectus est voluptates delectus et enim voluptatem ut exercitationem sequi.\r\n\r\nEst molestias aliquam sed molestiae mollitia aut impedit debitis sed quia sequi. Sed velit maiores est itaque natus qui corporis odit vel doloribus quasi aut dolores galisum. Ut atque error et excepturi consequatur et dolor atque eos totam maiores ut rerum inventore quo itaque corporis! At libero quis cum harum aperiam qui voluptatem similique est internos atque eos numquam ipsa.\r\n\r\nVel similique veritatis est aliquam omnis a rerum fugiat. Et iure ipsa est quasi obcaecati qui necessitatibus asperiores in quod quia vel ipsa rerum! In dolorem maiores vel quasi recusandae quo fuga dignissimos aut iste dolorem.',0,'2024-11-23 18:37:34.969825','2024-11-24 04:16:21.759454',2,0),(2,'Seminar Test','Other','2024-11-23 00:00:00.000000','ith the online text generator you can process your personal Lorem Ipsum enriching it with html elements that define its structure, with the possibility to insert external links, but not only.',0,'2024-11-23 22:45:26.295317','2024-11-23 22:45:26.295317',2,0);
...
INSERT INTO `studentskills` VALUES (1,0,'2024-11-15 18:25:47.169071',2,'C#'),(2,1,'2024-11-15 18:31:51.662198',2,'C++'),(7,1,'2024-11-16 00:31:44.499170',2,'React'),(8,1,'2024-11-16 00:32:19.608082',2,'Vue.js');
...
CREATE TABLE `studentsubjectstaken` (
  ...
  `SubjectStatus` int NOT NULL DEFAULT '0',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `studentsubjectstaken` VALUES (1,'2024-11-17 18:31:02.807720','2024-11-24 18:48:54.793408',2,5,1),(3,'2024-11-24 18:49:11.583569','2024-11-24 18:49:11.583624',2,6,0),(4,'2024-11-24 18:52:09.307890','2024-11-24 18:52:09.307890',2,3,0),(5,'2024-11-24 18:55:18.549798','2024-11-24 18:55:18.560156',2,4,2);
...
INSERT INTO `studentusers` VALUES (2,'hjsalamanca@gmail.com','Ra99L8oYKSMXYb4i+s9WOuDjsSRlo/Hyk6iquPzMZvY=',0,'admin1','2024-11-01 00:56:21.975722','admin1','2024-11-01 00:56:21.992196'),(3,'lance.villaroza@yahoo.com','ItU6dxeKzqzQo5M7TAdPNyy7xVOqkiU4R+g8aaU7auc=',0,'admin1','2024-11-15 09:47:34.123057','admin1','2024-11-15 09:47:34.144384');
...
-- Dump completed on 2024-11-26  0:36:42
